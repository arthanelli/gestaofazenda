...
const createTables = 'CREATE TABLE terreno(id SERIAL PRIMARY KEY, latidude decimal, longitude decimal, nome VARCHAR(200), area decimal, perimetro decimal, tipo VARCHAR(100));' +  
                     ...
                     'CREATE TABLE insumos(id SERIAL PRIMARY KEY, nome VARCHAR(100), tipo VARCHAR(200), preco decimal, fornecedor VARCHAR(100), descricao VARCHAR(200), quantidade integer, dataDeValidade VARCHAR(10));' +
                     'CREATE TABLE estoqueVacinas(id SERIAL PRIMARY KEY, nome VARCHAR(100), tipo VARCHAR(200), preco decimal, fornecedor VARCHAR(100), descricao VARCHAR(200), quantidade integer, dataDeValidade VARCHAR(10), indicacao VARCHAR(200), prescricao VARCHAR(200), diasDeCarencia integer, unidadeMedida VARCHAR(200), modoDeUso VARCHAR(200));' +
                     ...
                     'CREATE TABLE gado(brinco SERIAL PRIMARY KEY, nome VARCHAR(200), raca VARCHAR(100), sexo VARCHAR(100), dataNascimento VARCHAR(10), peso real,  pai VARCHAR(200), mae VARCHAR(200), loteanimal VARCHAR(120), status VARCHAR(100), observacoes VARCHAR(500), dataciclo VARCHAR(20));' +
